...
from autogen.methods.ccsd import generated
...
def test_equation_manifest_tracks_every_frozen_artifact() -> None:
    ...
    tracked = [manifest["source_spec"], *manifest["additional_source_specs"]]
    tracked.extend(manifest["generated_artifacts"])
